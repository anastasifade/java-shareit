...
public class UserServiceTests {
    ...
    private static final NewUserDto TEST_USER = new NewUserDto(NAME, EMAIL);
    ...
    void create_shouldTrimNameAndEmail() {
        NewUserDto dto = new NewUserDto(NAME + "  ", " " + EMAIL);
    ...
    void create_shouldThrow_ifEmailNotUnique() {
        service.create(TEST_USER);
        NewUserDto duplicateEmailDto = new NewUserDto("username123", TEST_USER.getEmail());
    ...
    void update_shouldUpdateUser() {
        ...
        UpdateUserDto dto = new UpdateUserDto(TEST_USER.getName() + "123", "123" + EMAIL);
    ...
    void update_shouldNotThrow_withUnchangedEmail() {
        Long id = service.create(TEST_USER).getId();
        UpdateUserDto dto = new UpdateUserDto(null, TEST_USER.getEmail());
        assertDoesNotThrow(() -> service.update(id, dto));
    }
    ...
    void update_shouldThrow_ifEmailNotUnique() {
        ...
        NewUserDto newUser = new NewUserDto("differentName", "differentEmail@something.com");
        Long id = service.create(newUser).getId();

        UpdateUserDto updateDto = new UpdateUserDto(null, TEST_USER.getEmail());
        assertThrows(DuplicateDataException.class, () -> service.update(id, updateDto));
    }

    @Test
    void update_shouldThrow_ifIdNotFound() {
        assertThrows(NotFoundException.class, () -> service.update(9999, new UpdateUserDto("", "")));
    }
